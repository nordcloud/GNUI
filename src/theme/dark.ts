...
const DARK_COLORS = [
  ...
  ["--interactive-secondary", palette.darkGrey.darkGrey75],
  ["--interactive-secondaryHover", palette.darkGrey.darkGrey50],
  ["--interactive-secondaryActive", palette.darkGrey.darkGrey100],
