...
- `fill`: `string` — **optional**: "success" | "danger" | "warning" | "notification" | "white"
...
<Preview>
  <Story name="colors">
    <Flex justifyContent="space-evenly">
        <SVGIcon name="dashboard" />
        <SVGIcon name="dashboard" fill="success"/>
        <SVGIcon name="dashboard" fill="danger"/>
        <SVGIcon name="dashboard" fill="warning"/>
        <SVGIcon name="dashboard" fill="notification"/>
    </Flex>
  </Story>
</Preview>
