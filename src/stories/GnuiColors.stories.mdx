...
<Preview>
  <Story name="Text colors">
    ...
    <Table>
      ...
      <Table.tbody>
        <Table.tr>
          <Table.td>theme.color.text.primary</Table.td>
          <Table.td>
            <ul>
              <li>Primary text;</li>
              <li>Body copy;</li>
        ...
        <Table.tr>
          <Table.td>theme.color.text.secondary</Table.td>
          <Table.td>
            <ul>
        ...
        <Table.tr>
          <Table.td>theme.color.text.placeholder</Table.td>
          <Table.td>
            <ul>
        ...
        <Table.tr>
          <Table.td>theme.color.text.invert</Table.td>
          <Table.td>
            <ul>
...
<Preview>
  <Story name="Border colors">
    ...
    <Table>
      ...
      <Table.tbody>
        <Table.tr>
          <Table.td>theme.color.border.default</Table.td>
          <Table.td>
            <ul>
        ...
        <Table.tr>
          <Table.td>theme.color.border.hover</Table.td>
          <Table.td>
            <ul>
