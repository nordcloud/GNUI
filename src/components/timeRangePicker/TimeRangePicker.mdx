...
| preserveDaySelection |  false   | boolean                                       | Whether to preserve week day selection when changing week (Type "Hours" only)                             |
...
<Canvas>
  <Story of={TimeRangePickerStories.TimerangepickerOfDays} />
</Canvas>
...
<Canvas>
  <Story of={TimeRangePickerStories.TimerangepickerOfHoursWithPreservedDaySelection} />
</Canvas>

## Type "Hours" with Histogram

<Canvas>
  <Story of={TimeRangePickerStories.TimerangepickerOfHoursWithHistogram} />
</Canvas>
