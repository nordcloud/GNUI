  ...
  <Story name="menu">
    <Flex justifyContent="space-evenly">
      ...
      <CopyToClipboard text="report">
        <SVGIcon name="report" size="lg" />
      </CopyToClipboard>
      <CopyToClipboard text="detailsView">
        <SVGIcon name="detailsView" size="lg" />
      </CopyToClipboard>
      <CopyToClipboard text="listView">
        <SVGIcon name="listView" size="lg" />
      </CopyToClipboard>
      <CopyToClipboard text="wizardView">
        <SVGIcon name="wizardView" size="lg" />
      </CopyToClipboard>
    </Flex>
  </Story>
</Preview>
...
<Preview>
  <Story name="ui">
    <Flex justifyContent="space-evenly" style={{ flexWrap: "wrap" }}>
      ...
      <CopyToClipboard text="recalculation">
        <SVGIcon name="recalculation" />
      </CopyToClipboard>
      <CopyToClipboard text="recalculationInProgress">
        <SVGIcon name="recalculationInProgress" />
      </CopyToClipboard>
