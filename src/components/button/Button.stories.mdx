...
| -----------: | :------: | :------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|     children |  false   | string                                                         | button label                                                                                                                                                                                                                           |
|     severity |  false   | <code>medium</code>, <code>low</code>                          |                                                                                                                                                                                                                                        |
|         size |  false   | <code>sm</code>, <code>md</code>                               |                                                                                                                                                                                                                                        |
|         icon |  false   | string                                                         | to get icon names look into SVG icon component                                                                                                                                                                                         |
...
|      display |  false   | <code>flex</code>, <code>inline-flex</code>                    | you might have change Button with linkTo from inline to block                                                                                                                                                                          |
