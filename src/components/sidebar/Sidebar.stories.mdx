...
<Canvas>
  <Story name="side">
    {() => {
      const { isOpen: isOpenLeft, toggle: toggleLeft } = useDisclosure();
      const { isOpen: isOpenRight, toggle: toggleRight } = useDisclosure();
      return (
        <Container>
          <Row justify="center">
...
<Canvas>
  <Story name="custom width">
    {() => {
      const { isOpen: isOpenPercent, toggle: togglePercent } = useDisclosure();
      const { isOpen: isOpenRem, toggle: toggleRem } = useDisclosure();
      const { isOpen: isOpenPx, toggle: togglePx } = useDisclosure();
      return (
        <Container>
          <Row justify="space-around">
            <Col md={2}>
