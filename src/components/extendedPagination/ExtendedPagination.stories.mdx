...
<Preview>
  <Story name="short">
    ...
    <ExtendedPaginationBox count={20} from={0} size={20} setPage={0} setSize={20} />
    <ExtendedPaginationBox count={60} from={20} size={20} setPage={0} setSize={20} />
    <ExtendedPaginationBox count={40} from={0} size={20} setPage={0} setSize={20} />
    <ExtendedPaginationBox count={40} from={20} size={20} setPage={0} setSize={20} />
    <ExtendedPaginationBox count={100} from={20} size={20} setPage={0} setSize={20} />
    <ExtendedPaginationBox count={100} from={80} size={20} setPage={0} setSize={20} />
    <ExtendedPaginationBox count={120} from={80} size={20} setPage={0} setSize={20} />
