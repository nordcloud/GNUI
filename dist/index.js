...
var ContentLoader__default = /*#__PURE__*/_interopDefaultCompat(ContentLoader);
...
var f=React__namespace.default,k=Symbol.for("react.element"),l=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,n=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};
...
const useClickOutside = ({ ref, active = true, onClickAway, events = defaultEvents, }) => {
    const savedCallback = React__namespace.useRef(onClickAway);
...
function useDisclosure(isOpenDefault = false) {
    ...
    const toggle = React.useCallback((toSet) => {
...
const PaddingWrapper = styled__default.default.div `
...
function useViewportDimensions(addResizeListener) {
    const [viewportDimensions, setViewportDimensions] = React.useState(getViewportDimensions);
    React.useEffect(() => {
...
const bp = styledComponentsBreakpoint.createBreakpoint(breakpoints);
const map = styledComponentsBreakpoint.createMap(breakpoints);
...
const StyledSVGIcon = styled__default.default.svg `
...
function SVGIcon({ name, ...props }) {
    const Path = React__namespace.useMemo(() => getPath(name), [name]);
...
const StyledAccordion = styled__default.default.div `
  ${styledSystem.space}
`;
const StyledAccordionItem = styled__default.default.div `
...
const StyledHeader = styled__default.default.div `
  ...
  ${({ isOpen }) => isOpen &&
    ...
    `}
`;
const HeaderTitle = styled__default.default.span `
  margin-left: ${theme.spacing.spacing02};
  text-transform: ${theme.typography.titleCase};
`;
const HeaderDescription = styled__default.default.div `
  color: ${theme.color.text.text02};
  font-size: ${theme.fontSizes.sm};
  margin-left: auto;
  font-weight: ${theme.fontWeights.regular};
`;
const HeaderIcon = styled__default.default.div `
  display: flex;
...
const StyledBarChart = styled__default.default.svg `
  width: 100%;
  height: 1.5rem;
...
function BrickLoader({ height, ...props }) {
    return (jsxRuntimeExports.jsx(ContentLoader__default.default, { speed: 2, backgroundColor: theme.color.background.ui02, foregroundColor: theme.color.background.ui04, style: { width: "100%", height: height ?? "100%" }, ...props, children: jsxRuntimeExports.jsx("rect", { x: "0", y: "0", rx: "0", ry: "0", width: "100%", height: "100%" }) }));
}
...
const StyledRing = styled__default.default.div `
  ${styledSystem.color};
  display: flex;
  position: relative;
  width: ${theme.iconSize.md};
...
const Button = React__namespace.forwardRef(({ children, icon, initialState, linkTo, as, ...props }, ref) => {
  ...
  ${({ color, severity }) => color &&
    styled.css `
      ...
      &:hover {
        ...
        : theme.color.text.text04};
        background-color: ${severity === "medium"
        ? polished.lighten(0.35, setColor(color))
        : polished.darken(0.1, setColor(color))};
      }
      &:active {
        background: ${severity === "medium"
        ? polished.lighten(0.25, setColor(color))
        : polished.darken(0.2, setColor(color))};
      }
    `}
  ${styledSystem.space}
`;
...
const StyledContainer = styled__default.default.div `
  ...
  ${styledSystem.space};
`;
const Container$4 = React__namespace.forwardRef(({ children, ...props }, ref) => (jsxRuntimeExports.jsx(StyledContainer, { ...props, ref: ref, children: children })));
/**
 * @deprecated Please use FlexContainer
 */
const Flex = styled__default.default(Container$4) `
  display: flex;
...
const FlexContainer = styled__default.default.div `
  display: flex;
  ${getFlexCss}
...
const StyledBox = styled__default.default(Container$4) `
  box-sizing: border-box;
  min-width: 0;
...
`;
const StyledBreadcrumbs = styled__default.default.nav `
  ul {
    padding: 0;
    margin: 0;
    line-height: 1.125rem;
...
`;
const disabledLinkStyles = styled.css `
  pointer-events: none;
  color: ${theme.color.text.text02};
`;
...
`;
const CheckboxLabel$1 = styled__default.default.label `
  cursor: pointer;
  margin-left: ${theme.spacing.spacing02};
  font-weight: ${theme.fontWeights.medium};
  ...
  ${({ withoutLabel }) => withoutLabel &&
    ...
    `}
`;
const CheckboxContainer$1 = styled__default.default.div `
  cursor: pointer;
  width: 1rem;
  height: 1rem;
  position: relative;
...
`;
const Fill$2 = styled__default.default.div `
  background: ${theme.color.background.ui05};
  width: 0;
  height: 0;
  position: absolute;
...
`;
const FillInter = styled__default.default(Fill$2) ``;
const CheckboxWrapper = styled__default.default(Container$4) `
  position: relative;
...
`;
const CheckboxInput$1 = styled__default.default.input `
  opacity: 0;
  z-index: 2;
  position: absolute;
  top: 0;
...
const IndeterminateCheckbox = React__namespace.forwardRef(({ indeterminate = false, id, ...rest }, ref) => {
    const defaultRef = React__namespace.useRef(null);
...
`;
const Fill$1 = styled__default.default(SVGIcon) `
  border-radius: 2px;
...
`;
const CheckmarkCheckbox = React__namespace.forwardRef(({ id, labelText, withoutLabel, double, ...props }, ref) => {
...
const TreeWrap = styled__default.default.div `
  pointer-events: ${(props) => (props.disabled ? "none" : "auto")};
  opacity: ${(props) => (props.disabled ? 0.3 : 1)};
`;
const CheckboxWrap = styled__default.default.div `
  padding: ${theme.spacing.spacing02};
`;
const TreeItem = styled__default.default.div `
  border-top: ${(props) => props.isTopItem ? theme.borders.disabled : "transparent"};
  border-bottom: ${theme.borders.disabled};
  padding: ${theme.spacing.spacing02};
`;
const Indentation = styled__default.default.div `
  padding-left: ${(props) => props.isRootElement ? theme.spacing.spacing00 : theme.spacing.spacing07};
`;
const MinusIcon = styled__default.default.div `
  transform: rotate(90deg);
  padding-left: 5px;
  padding-right: 5px;
  display: flex;
...
function CheckboxTree({ composition, expanded, selected, onChange, onExpand, preferredSeparator = "->", disabled, }) {
    const processedTree = React__namespace.useMemo(() => preProcessTree(composition, preferredSeparator), [composition, preferredSeparator]);
    const [selectedList, setSelectedList] = React__namespace.useState(selected ?? []);
    const [expandedList, setExpandedList] = React__namespace.useState(expanded ?? []);
    const [indeterminate, setIndeterminate] = React__namespace.useState([]);
    React__namespace.useEffect(() => {
        if (onChange) {
    ...
    const getParentsUidsMemo = React__namespace.useMemo(() => selected?.map((id) => getParentsUids(id, preferredSeparator)).flat(), [selected]);
    React__namespace.useEffect(() => {
...
const InputGroup = styled__default.default(FlexContainer) `
  position: relative;
  align-items: center;
  border: 1px solid ${theme.color.border.input};
  padding: ${theme.spacing.spacing02};
...
const StyledInput = styled__default.default.input `
  ...
  ${({ popup }) => popup &&
    ...
    `}
`;
const Clear$1 = styled__default.default.button `
  display: flex;
  align-items: center;
  padding: 0 ${theme.spacing.spacing02};
  background: none;
...
const Input = React__namespace.forwardRef(({ noBorder, type, popup, status, loading, onClick, small, showClearButton, onClear = () => undefined, icon, ...props }, ref) => {
...
const StyledUpload = styled__default.default.div `
  color: ${theme.color.text.text01};
  background: ${theme.color.field.default};
  transition: ${theme.transition};
  line-height: ${theme.lineHeight};
...
const StyledLabel$1 = styled__default.default.label `
  ...
  padding: 0.5rem;
`;
const Upload = React__namespace.forwardRef(({ placeholder, id = "upload-file", ...props }, ref) => (jsxRuntimeExports.jsxs(StyledUpload, { children: [jsxRuntimeExports.jsxs(StyledLabel$1, { htmlFor: id, children: [placeholder, jsxRuntimeExports.jsx(SVGIcon, { name: "plus" })] }), jsxRuntimeExports.jsx(StyledInput, { type: "file", id: id, ...props, ref: ref })] })));

const ButtonWrapper = styled__default.default.div `
  margin: -0.25rem -0.25rem -0.25rem 0.5rem;
`;
const InputSearch = React__namespace.forwardRef(({ noBorder, type = "search", popup, status, loading, onClick, onSearch, small, icon = "search", ...props }, ref) => {
...
const InputPassword = React__namespace.forwardRef(({ noBorder, popup, status, onClick, small, showPasswordOnInit = false, ...props }, ref) => {
    const [showPassword, setShowPassword] = React__namespace.useState(showPasswordOnInit);
...
const StyledDescription = styled__default.default(Container$4) `
  font-size: ${theme.fontSizes.sm};
  color: ${theme.color.text.text02};
...
const DropdownWrapper = styled__default.default(Container$4) `
  position: relative;
  ${styledSystem.space}
`;
...
const DropdownIcon = styled__default.default.div `
  ...
  ${({ animate }) => animate &&
    ...
    `};
`;
const DropdownMenu = styled__default.default(Container$4) `
  text-align: left;
  width: 100%;
  max-height: 90vh;
  overflow: auto;
...
`;
const Inner$2 = styled__default.default.span `
  margin-right: 1rem;
`;
const Clear = styled__default.default.span `
  position: absolute;
  top: 0;
  bottom: 0;
  right: 2rem;
...
function Dropdown({ value = "", name, options, disabled = false, title, onChange, onClear, minNumOfOptionsToShowSearchBox = 4, size, ...props }) {
    ...
    const wrapper = React__namespace.useRef(null);
...
const StyledSubmit = styled__default.default.input `
  background: ${theme.color.interactive.primary};
  font-family: ${theme.fonts.body};
  color: ${theme.color.text.text04};
...
const StyledListItemTitle = styled__default.default.span `
  width: 11.25rem;
  color: ${theme.color.text.text02};
`;
const StyledListMarker = styled.css `
  content: "";
  border-radius: 1px;
  width: 8px;
  min-width: 8px;
...
const StyledListItem = styled__default.default.li `
  font-family: ${theme.fonts.body};
  display: flex;
...
function List(props) {
    return (jsxRuntimeExports.jsx(StyledList, { ...props, children: props.items?.map((item, index) => {
            // Nested object
            if (isNested(item)) {
                return (jsxRuntimeExports.jsxs(React__namespace.Fragment, { children: [jsxRuntimeExports.jsx(ListItem$2, { ...props, ...item }), jsxRuntimeExports.jsx(List, { horizontal: props.horizontal, unordered: props.unordered, items: item.rowChildren })] }, `id-${item.title}`));
            }
...
function ListItem$1({ children = jsxRuntimeExports.jsx(DefaultItemsSkeleton, {}) }) {
    return (jsxRuntimeExports.jsx(ContentLoader__default.default, { speed: 2, backgroundColor: theme.color.background.ui02, foregroundColor: theme.color.background.ui04, style: { width: "100%", height: "80px" }, children: children }));
}
...
const LoaderPosition = styled__default.default.div `
  width: 14rem;
  position: fixed;
  ...
  ${({ position }) => position &&
    ...
    `};
`;
const LoaderOverlay = styled__default.default.div `
  top: 0;
  right: 0;
  bottom: 0;
  left: 0;
...
const StyledPaginationBox = styled__default.default.nav `
  display: flex;
  position: relative;
  flex-wrap: wrap;
...
const Container$3 = styled__default.default(StyledPaginationBox) `
...
function LoadMoreList({ initialItems = ["Item 1", "Item 2", "Item 3", "Item 4", "Item 5"], totalItems = 15, batchSize = 5, loadingDelay = 1000, withShowAll = false, }) {
    const [items, setItems] = React__namespace.useState(initialItems);
...
`;
const showTranslateY = styled.keyframes `
  from {
...
`;
const ModalBox = styled__default.default(Box) `
...
`;
const ModalCloseButton = styled__default.default(Button) `
  padding: ${theme.spacing.spacing01};
`;
const ModalAction = styled__default.default(Button) `
...
`;
const ModalHeading$1 = styled__default.default(Heading) `
  margin: 0;
`;
...
const ModalHeading = styled__default.default(Heading) `
  margin: 0;
`;
...
function getOptionBgColor(isDisabled, isSelected, isFocused) {
    return (color) => {
        ...
        if (isFocused) {
            return polished.rgba(color, 0.1);
        }
        return undefined;
    };
}
...
const customMultiColorStyles = {
    ...
    option: (styles, { data, isDisabled, isFocused, isSelected }) => {
        ...
        const contrastingColor = polished.getContrast(baseColor, "white") > 2 ? "white" : "black";
...
function SelectInner({ styles = getDefaultStyles(), ...props }, ref) {
    return (jsxRuntimeExports.jsx(SelectContainer, { isError: props.isError, children: jsxRuntimeExports.jsx(ReactSelect__default.default, { ref: ref, className: "react-select-container", classNamePrefix: "react-select", styles: styles, theme: (reactSelectTheme) => ({
                ...reactSelectTheme,
                colors: {
...
const Select = React__namespace.forwardRef(SelectInner);
...
`;
const Info = styled__default.default.span `
  width: 1.25rem;
  height: 1.25rem;
...
const PageTitleWrapper = styled__default.default.div `
  h3 {
    line-height: 2rem;
    font-weight: ${theme.fontWeights.medium};
    margin: 0 0 ${theme.spacing.spacing01};
...
const StyledPieChartWrap = styled__default.default.div `
  display: flex;
  position: relative;
  ${styledSystem.space}
`;
const StyledPieChartDescription = styled__default.default.div `
  position: absolute;
  left: 0;
  top: 0;
  display: flex;
...
const StyledSVG = styled__default.default.svg `
  ...
  ${({ size }) => size &&
    ...
    `}
`;
const StyledCircleBgr = styled__default.default.circle `
  fill: none;
  ...
  ${({ color }) => color &&
    ...
    `}
`;
const StyledCircleProgress = styled__default.default.circle `
...
function PieChart({ size, progress, strokeWidth, color = "success", children, ...props }) {
    ...
    const [offset, setOffset] = React__namespace.useState(circumference);
    React__namespace.useEffect(() => {
...
const StyledPopover = styled__default.default.div `
  display: inline-block;
  position: relative;
`;
const Content$1 = styled__default.default.div `
  ...
  ${({ alignRight }) => alignRight &&
    ...
    `}
`;
const StyledTrigger = styled__default.default.div `
  position: relative;
  cursor: pointer;
`;
...
const Radio = React__namespace.forwardRef(({ id, labelText, ...props }, ref) => (jsxRuntimeExports.jsxs(RadioFlexWrapper, { children: [jsxRuntimeExports.jsxs(RadioContainer, { children: [jsxRuntimeExports.jsx(RadioInput, { ref: ref, type: "radio", id: id, ...props }), jsxRuntimeExports.jsx(Fill, {})] }), jsxRuntimeExports.jsx("label", { htmlFor: id, children: labelText })] })));
function RadioGroup({ children, name }) {
    const [isChecked, setIsChecked] = React__namespace.useState(Array.isArray(children) && children[0].props.value);
    const hasNoChildren = Array.isArray(children) && children.length === 0;
    if (hasNoChildren) {
        return null;
    }
    return (jsxRuntimeExports.jsx(RadioWrapper, { role: "radiogroup", name: name, children: React__namespace.Children.map(children, (element) => React__namespace.cloneElement(element, {
            ...element.props,
            checked: isChecked === element.props.value,
            onChange: () => setIsChecked(element.props.value),
        })) }));
}
const RadioWrapper = styled__default.default(Container$4) `
  position: relative;
`;
const RadioFlexWrapper = styled__default.default(Flex) `
  margin-bottom: ${theme.spacing.spacing04};
...
`;
const Fill = styled__default.default.div `
  background: ${theme.color.interactive.primary};
  width: 0;
  height: 0;
  border-radius: 100%;
    ...
    li {
      ...
      button {
        ...
        &.active {
          ...
          &:hover {
            background: ${polished.darken(0.1, theme.colors[status] || status)};
          }

          &:active {
            background: ${polished.darken(0.2, theme.colors[status] || status)};
          }

          &:disabled {
            background: ${polished.darken(0.3, theme.colors[status] || status)};
          }
        }
      }
    }
...
const StyledSelectButtons = styled__default.default.ul `
  margin: 0;
  padding: 0;
  display: inline-flex;
  list-style: none;
...
const Title = styled__default.default(Text) `
  ...
  ${styledSystem.space}
`;
const Caption = styled__default.default(Text) `
  font-size: ${theme.fontSizes.sm};
  color: ${theme.color.text.text02};
  margin-bottom: 0;
`;
const Content = styled__default.default(Text) `
  font-weight: ${theme.fontWeights.regular};
  line-height: ${theme.lineHeight};
  font-size: ${theme.fontSizes.md};
  ...
  margin-bottom: 0;
`;
const SidebarMenu = styled__default.default.div `
  top: 0;
  right: 0;
  left: 0;
  bottom: 0;
...
`;
const CloseLayer = styled__default.default.div `
  background-color: transparent;
  position: absolute;
  top: 0;
  right: 0;
  ...
  z-index: ${theme.zindex.default};
`;
const Inner$1 = styled__default.default.div `
  position: relative;
  display: flex;
  flex-direction: column;
  overflow-x: hidden;
...
const Container = styled__default.default.div `
  ...
  flex: 1;
`;
const SidebarCloseButton = styled__default.default(Button) `
  padding: 0;
  z-index: ${theme.zindex.topoftheworld};
`;
const FooterSidebar = styled__default.default.div `
  position: sticky;
  z-index: ${theme.zindex.sticky};
  bottom: 0;
  right: 0;
...
function Sidebar({ children, title, caption, side, isOpen, footer, headerStyles, contentStyles, onClick = () => undefined, showExpandButton = false, onExpandClick = () => undefined, ...props }) {
    ...
    return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsx(Background, { isVisible: isOpen, zIndex: "overlay", onClick: onClick }), jsxRuntimeExports.jsxs(SidebarMenu, { isOpen: isOpen, side: side, reverse: side === "onLeft", children: [jsxRuntimeExports.jsx(Inner$1, { isOpen: isOpen, ...props, children: isOpen && (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsxs(Header, { reverse: side === "onLeft", style: headerStyles, children: [jsxRuntimeExports.jsxs("header", { children: [jsxRuntimeExports.jsx(Title, { tag: "span", ml: side === "onLeft" ? ["1rem", "1rem"] : [0], children: title }), caption && jsxRuntimeExports.jsx(Caption, { children: caption })] }), jsxRuntimeExports.jsxs(FlexContainer, { justifyContent: "space-evenly", children: [jsxRuntimeExports.jsx(reactIf.When, { condition: showExpandButton, children: jsxRuntimeExports.jsx(Button, { severity: "low", size: "md", icon: "externalLink", title: "Expand", type: "button", marginRight: 1, onClick: onExpandClick }) }), jsxRuntimeExports.jsx(Button, { severity: "low", size: "md", icon: "close", title: "Close sidebar", type: "button", onClick: onClick })] })] }), jsxRuntimeExports.jsx(Container, { style: contentStyles, children: jsxRuntimeExports.jsx(Content, { tag: "div", children: children }) }), footer && jsxRuntimeExports.jsx(FooterSidebar, { children: footer })] })) }), isOpen && jsxRuntimeExports.jsx(CloseLayer, { isOpen: isOpen, onClick: onClick, ...props })] })] }));
}
...
`;
const LabelText = styled__default.default.div `
  display: inline-block;
  margin-right: ${theme.spacing.spacing02};
  ...
  ${({ position }) => position === "left"
    ...
    : styled.css `
        ...
        `}
`;
const SwitchContainer = styled__default.default.div `
  position: relative;
  display: inline-block;
  width: 3rem;
  height: 1.5rem;
`;
const SwitchLabel = styled__default.default.label `
  display: flex;
  align-items: center;
  font-weight: ${theme.fontWeights.regular};
  font-family: ${theme.fonts.body};
...
function isReactFragment(element) {
    ...
    return element.type === React__namespace.Fragment;
}
...
/* stylelint-disable no-descending-specificity */
const TabsContent = styled__default.default(Box) `
  background-color: ${theme.color.background.ui01};
  border-top-left-radius: 0;
  border-top-right-radius: 0;
  box-shadow: none;
...
`;
const TabContainer = styled__default.default.div `
  padding: ${theme.spacing.spacing04};
  background-color: ${theme.color.background.ui03};
...
`;
const TabsList = styled__default.default.div `
  background-color: ${theme.color.background.ui03};
  display: flex;
  padding: 0;
  margin: 0;
...
`;
const TabsWrapper = styled__default.default(Box) `
  padding: 0;
`;
const Step = styled__default.default(Box) `
  padding: 0;
  display: flex;
  align-items: center;
  justify-content: center;
...
`;
const TabsStatusButtons = styled__default.default.div `
  padding: ${theme.spacing.spacing04};
  border-top: 1px solid ${theme.color.border.border01};
  display: flex;
  ...
  position: relative;
`;
const TabsCover = styled__default.default.div `
  background-color: ${theme.color.background.ui01};
  border-bottom-left-radius: ${theme.radiusDefault};
  border-bottom-right-radius: ${theme.radiusDefault};
`;
const PreviousButton = styled__default.default(Button) `
  position: absolute;
  border: none;
`;
const NextButton = styled__default.default(Button) `
  margin-left: auto;
  margin-right: auto;
`;
...
function Tabs({ name, wizard, children, handleTab, step }) {
    const items = React__namespace.Children.toArray(flattenChildren(children));
    return (jsxRuntimeExports.jsxs(TabsWrapper, { children: [jsxRuntimeExports.jsx(TabsList, { className: name, children: items.map((child, key) => {
                    ...
                    return (jsxRuntimeExports.jsxs(React__namespace.Fragment, { children: [jsxRuntimeExports.jsx(TabsContent, { children: innerChildren }), buttons != null && (jsxRuntimeExports.jsx(TabsStatusButtons, { buttonsJustify: buttonsJustify, children: buttons }))] }, key));
                }) })] }));
}
...
const Tfoot = styled__default.default.tfoot `
  td {
    background-color: ${theme.color.background.ui01};
  }
`;
...
const Row = styled__default.default(FlexContainer) `
  align-items: stretch;
...
`;
const SelectWrap = styled__default.default(FlexContainer) `
...
`;
const UnifiedMultipleSelect = styled__default.default(MultipleSelect) `
  width: 100%;
  li {
    flex: 1;
...
const getMonday = (date) => {
    ...
    return dateFns.isMonday(currentDate) ? currentDate : dateFns.previousMonday(currentDate);
};
const getTimeRangeDate = (initRange) => {
    return dateFns.isSameDay(initRange.start, initRange.end)
...
const getDateWithDays = (date, rangeType, dateFormat) => {
    switch (rangeType) {
        ...
        case RANGE_TYPE.WEEK:
            return `${dateFns.format(new Date(date), dateFormat)} - ${dateFns.format(dateFns.addWeeks(date, 1), dateFormat)}`;
        case RANGE_TYPE.MONTH:
            return `${dateFns.format(new Date(date), dateFormat)} - ${dateFns.format(dateFns.addMonths(date, 1), dateFormat)}`;
        case RANGE_TYPE.YEAR:
            return `${dateFns.format(new Date(date), dateFormat)} - ${dateFns.format(dateFns.addYears(date, 1), dateFormat)}`;
        default:
            return undefined;
    }
};
const getDate = (selectedType, date, number) => {
    switch (selectedType) {
        case RANGE_TYPE.DAY:
            return dateFns.addDays(date, number);
        case RANGE_TYPE.WEEK:
            return dateFns.addWeeks(date, number);
        case RANGE_TYPE.MONTH:
            return dateFns.addMonths(date, number);
        case RANGE_TYPE.YEAR:
            return dateFns.addYears(date, number);
        default:
            return date;
    }
};
...
const getDateOptions = (monday, weekCounts) => {
    ...
    return WEEKDAYS.map((weekday, index) => {
        const currentDate = dateFns.addDays(monday, index);
        return {
...
const getDailyCounts = (date, weekCounts) => weekCounts.find((item) => dateFns.isSameDay(item.date, date))?.counts ??
...
const isSameTimeRange = (interval, timeRangeOption) => {
    ...
    return (dateFns.getHours(interval.start) === optionStart &&
        dateFns.getHours(interval.end) === optionEnd);
};

const dateFormat = "dd MMM yyyy";
function DatesPicker({ initTimeRange, disabledDays, onChange, }) {
    const [selectedDate, setSelectedDate] = React.useState(getTimeRangeDate(initTimeRange));
    const [selectedDateRange, setSelectedDateRange] = React.useState({ from: new Date() });
    const [selectedRangeType, setSelectedRangeType] = React.useState(DEFAULT_RANGE_TYPES[0]);
    const calendarWrapper = React.useRef(null);
    ...
    const handleDateSelection = (newSelectDate) => {
        ...
        if (!dateFns.isSameDay(newSelectDate, selectedDate)) {
...
`;
const CountTag = styled__default.default(Tag) `
  margin: 0;
...
const CountBarWrapper = styled__default.default.div `
  position: relative;
  height: 100%;
...
`;
const CountBar = styled__default.default.div `
  position: absolute;
  bottom: 0;
  width: 100%;
...
function DateOptionLabel({ dateOption, loading }) {
    ...
    return (jsxRuntimeExports.jsxs(FlexContainer, { justifyContent: hasCounts ? "space-between" : "center", alignItems: "stretch", gap: theme.spacing.spacing02, children: [jsxRuntimeExports.jsxs("div", { children: [jsxRuntimeExports.jsx("header", { children: dateOption.weekday }), jsxRuntimeExports.jsx("time", { className: "date-value", dateTime: dateOption.id, children: getDateString(new Date(dateOption.id)) })] }), jsxRuntimeExports.jsx(reactIf.When, { condition: hasCounts, children: jsxRuntimeExports.jsxs(reactIf.If, { condition: loading, children: [jsxRuntimeExports.jsx(reactIf.Then, { children: jsxRuntimeExports.jsx("div", { style: { alignSelf: "center" }, children: jsxRuntimeExports.jsx(Spinner, {}) }) }), jsxRuntimeExports.jsx(reactIf.Else, { children: jsxRuntimeExports.jsx(FlexContainer, { gap: "2px", children: (dateOption.counts ?? DEFAULT_DAILY_COUNTS).map((percentage, index) => (jsxRuntimeExports.jsx(CountBarWrapper, { children: jsxRuntimeExports.jsx(CountBar, { height: percentage }) }, `${dateOption.id}-${DEFAULT_TIME_RANGE_OPTIONS[index].id}`))) }) })] }) })] }));
}
...
function DateSelector({ dateOptions, selectedDate, disabledDays, loading, onSelect, }) {
    return (jsxRuntimeExports.jsx("div", { className: "date-options", children: jsxRuntimeExports.jsx(UnifiedMultipleSelect, { size: "small", children: dateOptions.map((dateOption) => {
                ...
                return (jsxRuntimeExports.jsx(SelectButton, { name: dateOption.id, value: dateOption.id, isActive: dateOption.id === selectedDate.toDateString(), disabled: reactDayPicker.isMatch(date, disabledDays) || loading, labelText: jsxRuntimeExports.jsx(DateOptionLabel, { dateOption: dateOption, loading: loading }), onClick: () => onSelect(date) }, dateOption.id));
            }) }) }));
}

function TimeRangeLabel({ timeRangeOption, justifyContent }) {
    return (jsxRuntimeExports.jsxs(FlexContainer, { justifyContent: justifyContent, alignItems: "center", children: [jsxRuntimeExports.jsx("span", { children: `${timeRangeOption.start} - ${timeRangeOption.end}` }), jsxRuntimeExports.jsx(reactIf.When, { condition: timeRangeOption.count !== 0, children: jsxRuntimeExports.jsx(CountTag, { text: timeRangeOption.count.toString(), color: "blue", colorText: "white" }) })] }));
}
...
function DateHourPicker({ initTimeRange, weekCounts, countsLoading = false, disabledDays, onChange, onWeekChange, }) {
    const [selectedDate, setSelectedDate] = React.useState(getTimeRangeDate(initTimeRange));
    const [dateOptions, setDateOptions] = React.useState(getDateOptions(getMonday(initTimeRange.start)));
    const [timeRangeOptions, setTimeRangeOptions] = React.useState(DEFAULT_TIME_RANGE_OPTIONS);
    const [selectedTimeRange, setSelectedTimeRange] = React.useState(getInitSelectedTimeRange(initTimeRange));
    React.useEffect(() => {
        if (!dateFns.isSameDay(selectedDate, initTimeRange.start) ||
    ...
    const updateDateOptions = (direction) => {
        ...
        const newMonday = direction === "backward"
            ? dateFns.previousMonday(currentMonday)
            : dateFns.nextMonday(currentMonday);
    ...
    const updateTimeRangeOptions = (date) => {
        ...
        const dayCounts = weekCounts.find((item) => dateFns.isSameDay(item.date, date))
            ?.counts;
        if (dayCounts) {
...
const StyledToggle = styled__default.default.button `
  border: 1px solid ${theme.color.interactive.primary};
  border-radius: ${theme.radiusDefault};
  line-height: ${theme.lineHeight};
  color: ${theme.color.text.text01};
...
function useTooltipHover() {
    ...
    const timerRef = React__namespace.useRef(-1);
...
const TooltipWrapper$1 = styled__default.default.div `
  display: inline-block;
`;
const StyledTooltip$1 = styled__default.default.div `
  position: absolute;
...
function Tooltip$1({ status, position, caption, bottom = false, children, hideTimeout = 100, showTimeout = 300, minWidth = "0", }) {
    ...
    const [tooltipPosition, setPosition] = React__namespace.useState({
        marginTop: 0,
        width: 0,
    });
...
const TextareaGroup = styled__default.default.div `
  position: relative;
  align-items: center;
  border: 1px solid ${theme.color.border.input};
  padding: ${theme.spacing.spacing02};
...
`;
const Counter = styled__default.default.p `
  color: ${theme.color.text.text03};
  font-size: ${theme.fontSizes.sm};
  text-align: right;
  ${({ status }) => status === "danger" &&
    ...
    `};
`;
const TextareaFlexContainer = styled__default.default.div `
  display: flex;
  flex-direction: column;
...
const Textarea = React__namespace.forwardRef(({ status, maxCharCount, ...props }, ref) => {
    const [charCount, setCharCount] = React__namespace.useState(getDefaultCharCount(props));
    React__namespace.useEffect(() => {
        if (typeof props.value === "string") {
...
function Pagination({ count, from, set, size, firstPage = 0, small, }) {
    ...
    return (jsxRuntimeExports.jsx("nav", { className: `pagination ${!small ? "center-absolutely" : ""}`, role: "navigation", "aria-label": "pagination", children: jsxRuntimeExports.jsxs("ul", { className: "pagination-list", children: [jsxRuntimeExports.jsx(reactIf.When, { condition: currentPage > firstPage, children: jsxRuntimeExports.jsx("li", { children: jsxRuntimeExports.jsx("button", { type: "button", className: "pagination-prev", "data-testid": "prev-page", onClick: () => setPage(currentPage - 1), onKeyDown: () => setPage(currentPage - 1), children: jsxRuntimeExports.jsx(SVGIcon, { name: "chevronLeft" }) }) }) }), jsxRuntimeExports.jsxs(reactIf.When, { condition: showFirstPageJump, children: [jsxRuntimeExports.jsx("li", { children: jsxRuntimeExports.jsx("button", { type: "button", className: "pagination-link", "data-testid": "first-page", onClick: () => setPage(firstPage), onKeyDown: () => setPage(firstPage), children: jsxRuntimeExports.jsx("span", { children: "1" }) }) }), jsxRuntimeExports.jsx("li", { className: "dots", "data-testid": "first-page-dots", children: jsxRuntimeExports.jsx(Text, { tag: "div", children: "..." }) })] }), [...getPages()]
                ...
                }), jsxRuntimeExports.jsxs(reactIf.When, { condition: showLastPageJump, children: [jsxRuntimeExports.jsx("li", { className: "dots", "data-testid": "last-page-dots", children: jsxRuntimeExports.jsx(Text, { tag: "div", children: "..." }) }), jsxRuntimeExports.jsx("li", { children: jsxRuntimeExports.jsx("button", { type: "button", className: "pagination-link", "data-testid": "last-page", onClick: () => setPage(lastPage), onKeyDown: () => setPage(lastPage), children: jsxRuntimeExports.jsx("span", { children: nPages }) }) })] }), jsxRuntimeExports.jsx(reactIf.When, { condition: currentPage < nPages - (isFirstPageZero ? 1 : 0), children: jsxRuntimeExports.jsx("li", { children: jsxRuntimeExports.jsx("button", { type: "button", className: "pagination-next", "data-testid": "next-page", onClick: () => setPage(currentPage + 1), onKeyDown: () => setPage(currentPage + 1), children: jsxRuntimeExports.jsx(SVGIcon, { name: "chevronRight" }) }) }) })] }) }));
}
...
function ExtendedTooltip({ caption, children, placement = "top", position = "center", status, showTimeout = 0, hideTimeout = 0, margin = DEFAULT_MARGIN, zIndex = theme.zindex.sticky, display, adjustPositionToViewportSize = false, ...rest }) {
    ...
    const { isHovered, updateIsHovered } = useTooltipHover();
    const [tooltipDimensions, setTooltipDimensions] = React__namespace.useState(null);
    const [wrapperDimensions, setWrapperDimensions] = React__namespace.useState(null);
...
function Tooltip({ caption, isHovered, tooltipRef, status, positionStyle, style, ...rest }) {
    ...
    return isHovered
        ? ReactDOM__namespace.createPortal(jsxRuntimeExports.jsx(StyledTooltip, { ref: tooltipRef, status: status, style: { ...positionStyle, ...style }, zIndex: zIndex, ...rest, children: caption }), document.body)
        : null;
}
...
function ExtendedPopover({ trigger = (jsxRuntimeExports.jsx(Button, { size: "sm", children: jsxRuntimeExports.jsx(SVGIcon, { size: "sm", name: "burgerMenu" }) })), content, placement = "right", position = "start", clickOutsideToClose = true, margin = DEFAULT_MARGIN, triggerOn = "click", closeOn = "click", adjustPositionToViewportSize = false, zIndex = theme.zindex.sticky, scrollTarget, closeOnScroll = true, }) {
    ...
    const [contentDimensions, setContentDimensions] = React__namespace.useState(null);
    const [triggerDimensions, setTriggerDimensions] = React__namespace.useState(null);
    const viewportDimensions = useViewportDimensions(adjustPositionToViewportSize);
    ...
    const handleScroll = throttle(React__namespace.useCallback(() => {
        closePopover();
    }, []));
    useEvent({
        name: "scroll",
...
function Popover({ contentRef, visible, style, margin, content, placement, zIndex, }) {
    ...
    return visible
        ? ReactDOM__namespace.createPortal(jsxRuntimeExports.jsx(ContentWrapper, { ref: contentRef, style: positionStyle, zIndex: zIndex, children: jsxRuntimeExports.jsx(PaddingWrapper, { ...margin, placement: placement, children: content }) }), document.body)
        : null;
}
...
const ItemsContainer = styled__default.default.div `
  ...
  height: 100%;
`;
const ItemsSection = styled__default.default.div `
  display: flex;
  flex-wrap: nowrap;
  flex-direction: column;
...
const NavigationBarWrapper = styled__default.default.nav `
  display: flex;
  flex-wrap: nowrap;
  justify-content: flex-start;
  margin: 0;
...
const BurgerWrapper = styled__default.default.div `
  cursor: pointer;
  display: flex;
  flex-wrap: nowrap;
  margin: 0;
  ...
  box-sizing: border-box;
`;
const StyledPopoverTrigger = styled__default.default.div `
  display: flex;
  align-items: center;
  ...
  column-gap: ${theme.spacing.spacing02};
`;
const StyledTriggerWrapper = styled__default.default.div `
  display: flex;
  align-items: center;
  border-radius: ${theme.radius.md};
  cursor: pointer;
...
const NavigationBarContext = React__namespace.createContext(undefined);

function useMenuBarConfiguration() {
    const context = React__namespace.useContext(NavigationBarContext);
...
const scrollbarCustomStyles = styled.css `
  html {
...
exports.THEME_OPTIONS = void 0;
(function (THEME_OPTIONS) {
    THEME_OPTIONS["LIGHT"] = "LIGHT";
    THEME_OPTIONS["DARK"] = "DARK";
})(exports.THEME_OPTIONS || (exports.THEME_OPTIONS = {}));
function getPreferredBrowserTheme() {
    return window.matchMedia?.("(prefers-color-scheme: dark)").matches
        ? exports.THEME_OPTIONS.DARK
        : exports.THEME_OPTIONS.LIGHT;
}
function isThemeValue(value) {
    return value === "LIGHT" || value === "DARK";
}
const useThemeSwitcher = () => {
    const [currentTheme, setCurrentTheme] = React__namespace.useState(() => {
        const savedThemeValue = window.localStorage.getItem("NC_GNUI_THEME") ?? "";
        return isThemeValue(savedThemeValue)
            ? exports.THEME_OPTIONS[savedThemeValue]
            : getPreferredBrowserTheme();
    });
    React__namespace.useEffect(() => {
        const newTheme = currentTheme === exports.THEME_OPTIONS.DARK ? DARK_COLORS : LIGHT_COLORS;
    ...
    const setTheme = (value) => {
        ...
        localStorage.setItem("NC_GNUI_THEME", exports.THEME_OPTIONS[value]);
    };
...
exports.BrickLoader = BrickLoader;
...
exports.CheckmarkCheckbox = CheckmarkCheckbox;
exports.Clear = Clear;
...
exports.LoadMoreList = LoadMoreList;
...
exports.PageTitleBreadcrumbs = PageTitleBreadcrumbs;
...
exports.bp = bp;
exports.customMultiColorStyles = customMultiColorStyles;
exports.map = map;
exports.theme = theme;
